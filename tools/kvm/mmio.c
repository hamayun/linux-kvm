...
struct mmio_mapping {
	...
	void			(*mmio_fn)(struct kvm_cpu *, u64 addr, u8 *data, u32 len, u8 is_write, void *ptr);
	void			*ptr;
};
...
bool kvm__register_coalesced_mmio(struct kvm *kvm, u64 phys_addr, u64 phys_addr_len, void (*mmio_fn)(struct kvm_cpu *, u64 addr, u8 *data, u32 len, u8 is_write, void *ptr), void *ptr)
{
...
bool kvm__register_mmio(struct kvm *kvm, u64 phys_addr, u64 phys_addr_len, void (*mmio_fn)(struct kvm_cpu *, u64 addr, u8 *data, u32 len, u8 is_write, void *ptr), void *ptr)
{
	struct mmio_mapping *mmio;
	int ret;
...
bool kvm__emulate_mmio(struct kvm_cpu *cpu, u64 phys_addr, u8 *data, u32 len, u8 is_write)
{
	...
	if (mmio)
		mmio->mmio_fn(cpu, phys_addr, data, len, is_write, mmio->ptr);
	else
